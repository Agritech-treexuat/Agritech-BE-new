...
module.exports = function (app) {
  ...
  app.post('/farm/initProject', [authJwt.verifyToken, authJwt.isFarm, controller.upload], controller.initProject)

  app.post('/farm/project/addProcess/:projectId', [authJwt.verifyToken, authJwt.isFarm], controller.addProcessToProject)
  ...
  app.post('/farm/project/addOutput/:projectId', [authJwt.verifyToken, authJwt.isFarm], controller.addOutputToProject)

  app.post('/farm/project/addExpect/:projectId', [authJwt.verifyToken, authJwt.isFarm], controller.addExpectToProject)
  ...
  app.post('/farm/project/editInput/:projectId', [authJwt.verifyToken, authJwt.isFarm], controller.editInput)

  app.post('/farm/project/exportQR/:projectId/:outputId', [authJwt.verifyToken, authJwt.isFarm], controller.exportQR)

  app.post('/scanQR/:id/:clientId', [authJwt.verifyToken, authJwt.isClient], controller.scanQR)

  app.post(
    '/farm/addPlantCultivate/:projectId',
    [authJwt.verifyToken, authJwt.isFarm],
    controller.addPlantCultivateToProject
  )

  app.post(
    '/farm/updatePlantCultivate/:projectId',
    [authJwt.verifyToken, authJwt.isFarm],
    controller.updatePlantCultivateToProject
  )

  app.get('/farm/plan/:projectId', controller.getPlanFromProject)
